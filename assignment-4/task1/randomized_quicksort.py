"""Randomized Quicksort: the pivot is chosen uniformly at random from the subarray being partitioned

Reused from assignment-3 (task1/randomized_quicksort.py)
"""

...
**Recency and access.** Published May 2023, inside the 2017-to-today window. The authors distribute the full text freely at https://foyzulhassan.github.io/files/MSR23_HPC.pdf, which was re-downloaded and re-read during the references re-run; no paywall or login is involved. This is the author's preprint rather than the IEEE version of record, which is why locations below carry both paginations.
